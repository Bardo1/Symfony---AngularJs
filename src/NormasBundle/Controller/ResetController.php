...
{   
     ...
     */
    public function reestablecerAction()
    {
       // return $this->render('NormasBundle:Default:reset.html.twig');

            $enviado_por  ='walterrmz1@gmail.com';
            $enviado_para ='jimprueba12345@gmail.com';
            
            $message = \Swift_Message::newInstance()
                ->setSubject('Nuevo mensaje desde la web de Mandato Online.')
                ->setFrom($enviado_por)
                ->setTo($enviado_para)
                ->setContentType('text/html')
                ->setBody("esto es un body");
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        return new RedirectResponse($this->generateUrl('check_email', array('username' => $username)));
    }
    ...
    public function checkEmailAction(Request $request)
    {
        ...
        return $this->render('NormasBundle:Default:mensajeReset.html.twig', array(
